...
public class BasicGlideUrlLoader extends BaseGlideUrlLoader<String> {
    private static final ModelCache<String, GlideUrl> urlCache = new ModelCache<>(100);
    ...
    private BasicGlideUrlLoader(ModelLoader<GlideUrl, InputStream> concreteLoader, @Nullable ModelCache<String, GlideUrl> modelCache) {
    ...
    public static class Factory implements ModelLoaderFactory<String, InputStream> {
        ...
        public ModelLoader<String, InputStream> build(MultiModelLoaderFactory multiFactory) {
            return new BasicGlideUrlLoader(multiFactory.build(GlideUrl.class, InputStream.class), urlCache);
        }
