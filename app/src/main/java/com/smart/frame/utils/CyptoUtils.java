...
public class CyptoUtils {
    ...
    private static final class Holder{
        private static final CyptoUtils INSTANCE = new CyptoUtils();
    }
     ...
     * DES加密
     */
    public String encodeDES(String data){
        return TextUtils.isEmpty(data) ? "" : strEnc(data, Configs.CREDENTIALS_SALT,null,null);
    }
    ...
    public String decodeDES(String data){
        return TextUtils.isEmpty(data) ? "" : strDec(data, Configs.CREDENTIALS_SALT,null,null);
    }

    /**
     * MD5加密(32位)
     * 16位小写加密只需decodeMD5("xxx").substring(8, 24);即可
     */
    public String encodeMD5(String data) {
        try {
            MessageDigest bmd5 = MessageDigest.getInstance("MD5");
            bmd5.update(data.getBytes());
            int i;
