...
import com.smart.frame.ui.contactslist.common.IndexBar;
import com.smart.frame.ui.contactslist.common.Utils;
...
import com.smart.frame.ui.view.recycleview.OnItemClickListener;
    ...
    private void initAdapter() {
        ...
        mAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                Snackbar.make(mRecyclerView, "Clicked " + mContactList.get(position).getName(), Snackbar.LENGTH_SHORT).show();
            }
