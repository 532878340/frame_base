 ...
 */
package com.smart.frame.ui.contactslist.common;
...
public class FloatingBarItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public FloatingBarItemDecoration(Context context, Map<Integer, String> list) {
        ...
        mBackgroundPaint.setColor(ContextCompat.getColor(mContext, R.color.listitem_subtitle_text));

        mTextPaint = new Paint();
        mTextPaint.setColor(ContextCompat.getColor(mContext, R.color.gray_dark));
