...
package com.smart.frame.ui.view.wheel;
...
import com.smart.frame.ui.view.wheel.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private int[] SHADOWS_COLORS = new int[] { 0xFFededed,
			0x80ededed, 0x00ededed };
